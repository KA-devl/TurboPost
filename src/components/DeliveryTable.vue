            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                ...
                <td class="h-px w-px whitespace-nowrap">
                  <a class="block" href="javascript:;" data-hs-overlay="#hs-ai-invoice-modal">
                    <div class="px-6 py-2">
                      <span class="inline-flex items-center gap-1.5 py-0.5 px-2 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-red-900 dark:text-green-200">
    ...
    <div class="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-gray-800">
      ...
      <div class="p-4 sm:p-7 overflow-y-auto">
        ...
        <div class="mt-5 sm:mt-10 grid grid-cols-2 sm:grid-cols-3 gap-5">
          <div>
            <span class="block text-xs uppercase text-gray-500">Amount Delivred:</span>
            <span class="block text-sm font-medium text-gray-800 dark:text-gray-200">$316.8</span>
          </div>
          <!-- End Col -->

          <div>
            <span class="block text-xs uppercase text-gray-500">Date Delivred:</span>
