      ...
      <div class="flex flex-col p-4 sm:p-10 bg-white shadow-md rounded-xl dark:bg-gray-800">
        ...
        <div class="mt-8 grid sm:grid-cols-2 gap-3">
          <div>
            ...
            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">{{ nameBilling }}</h3>
          </div>
          <!-- Col -->
        ...
        <div class="mt-6">
          <div class="border border-gray-200 p-4 rounded-lg space-y-4 dark:border-gray-700">
            <div class="hidden sm:grid sm:grid-cols-5">
              ...
              <div class="text-start text-xs font-medium text-gray-500 uppercase">Package size</div>
            ...
            <div class="grid grid-cols-3 sm:grid-cols-5 gap-2">
              ...
              <div>
                ...
                <p class="text-gray-800 dark:text-gray-200">{{ height }}cm x {{ width }}cm x {{ length }}cm x {{ weight }}kg</p>
              </div>
              <div>
                <h5 class="sm:hidden text-xs font-medium text-gray-500 uppercase">Amount</h5>
                <p class="sm:text-end text-gray-800 dark:text-gray-200">${{ totalBeforeTax }}</p>
              </div>
            </div>
          ...
          <div class="w-full max-w-2xl sm:text-end space-y-2">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
              <dl class="grid sm:grid-cols-5 gap-x-3">
                ...
                <dd class="col-span-2 text-gray-500">${{ totalBeforeTax }}0</dd>
              </dl>

              <dl class="grid sm:grid-cols-5 gap-x-3">
                <dt class="col-span-3 font-semibold text-gray-800 dark:text-gray-200">Total:</dt>
                <dd class="col-span-2 text-gray-500">${{ totalAfterTax }}0</dd>
              </dl>
        ...
        <div class="mt-8 sm:mt-12">
          ...
          <div class="mt-2">
            <p class="block text-sm font-medium text-gray-800 dark:text-gray-200">contact@turbopost.com</p>
